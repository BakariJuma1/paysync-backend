...
class SalesmanDashboard(Resource):
    ...
    def get(self):
        ...
        total_balance = sum(d.balance for d in base_query.all())  # Python property usage
        ...
        customers = (
            db.session.query(
                ...
                Customer.phone,
                func.sum(Debt.total - Debt.amount_paid).label("balance")  # use hybrid property in SQL
            )
